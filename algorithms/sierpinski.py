...
def generate_sierpinski(width, height, depth=8):
    ...
    def _draw_triangle(x1, y1, x2, y2, x3, y3, depth):
        ...
        _draw_triangle(x1, y1, mx1, my1, mx3, my3, depth-1)
        _draw_triangle(mx1, my1, x2, y2, mx2, my2, depth-1)
        _draw_triangle(mx3, my3, mx2, my2, x3, y3, depth-1)
    
    y_top = height * 0.1  # Leave some margin at top
    y_bottom = height * 0.9  # Leave some margin at bottom
    _draw_triangle(width/2, y_top,  # top vertex
